...
# gen_wiki_filter(
#     "../datasets/wikipedia-cn-20230720-filtered.json"
# )
...
# gen_aplca_sft("../datasets/sftdata/self_cognition.json","../datasets/aplca3.parquet")
gen_aplca_sft("../datasets/sftdata/alpaca_gpt4_data_zh.json","../datasets/aplca1.parquet")

# gen_bell_sft("../datasets/train_2M_CN/train_2M_CN.json", "../datasets/bell3.parquet")
